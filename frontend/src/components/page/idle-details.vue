...
<style scoped>
    ...
    .no-images::before {
        ...
        border-radius: 7px;
        background: linear-gradient(135deg, #f3f4f6 0%, transparent 20%, transparent 80%, #f3f4f6 100%);
        opacity: 0;
        transition: opacity 0.3s ease;
    }

    .no-images:hover::before {
        opacity: 1; 
    }
    ...
    .no-images:hover .no-images-icon {
        background: #f0fdfa;
        border-color: #ccfbf1;
